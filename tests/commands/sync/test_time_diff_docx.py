...
async def test_upload(
    ...
    async with env:
        ...
        assert not env.routes.file.existing.post[Path('main.md')].called
        assert env.routes.file.existing.post[Path('output.docx')].called
...
async def test_download(
    ...
    async with env:
        ...
        assert env.routes.project_requirements.called
        assert env.routes.project_files.called
        assert not env.routes.file.existing.get[Path('main.md')].called
        assert env.routes.file.existing.get[Path('output.docx')].called
